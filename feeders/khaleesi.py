...
COMPONENT_TYPES = ['git_commit', 'repo']
...
if __name__ == '__main__':
    ...
    components.append(get_khaleesi('f99d6939-0a33-4845-8fe1-edfacabf4296'))
    components.append(get_khaleesi_settings('f99d6939-0a33-4845-8fe1-edfacabf4296'))

    components.append(get_osp_repo('927ecd12-94ba-4c19-9ba2-8e67732951c3'))
    components.append(get_ospd_repo('927ecd12-94ba-4c19-9ba2-8e67732951c3'))

    for component in components:
        l_feeder.create_component(component)
    
    l_feeder.create_jobdefinition('Khaleesi', 'd1b2d9cb-cac4-426a-96cb-7dfaf43d52fe')
