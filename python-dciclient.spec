...
%install
%py2_install
find %{buildroot}/%{python2_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '1s/bcrypt.*//' {} \;
find %{buildroot}/%{python2_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '4s/2.7.0/2.6.0/' {} \;
find %{buildroot}/%{python2_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '7s/click.*/click/' {} \;
find %{buildroot}/%{python2_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '8s/setuptools.*/setuptools/' {} \;
%if 0%{?with_python3}
%py3_install
find %{buildroot}/%{python3_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '1s/bcrypt.*//' {} \;
find %{buildroot}/%{python3_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '4s/2.7.0/2.6.0/' {} \;
find %{buildroot}/%{python3_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '7s/click.*/click/' {} \;
find %{buildroot}/%{python3_sitelib}/*.egg-info -name 'requires.txt' -exec sed -i '8s/setuptools.*/setuptools/' {} \;
%endif
