...
def file_upload(context, id, path):
    ...
    """
    result = component.upload_file(context, id=id, file_path=path)
...
def file_show(context, id, file_id):
    ...
    """
    result = component.get_file(context, id=id, file_id=file_id)
    utils.format_output(result, context.format, 'component_file',
                        component.TABLE_FILE_HEADERS)
...
def file_download(context, id, file_id, target):
    ...
    """
    component.download_file(context, id=id, file_id=file_id, target=target)
...
def file_list(context, id):
    ...
    :param string id: ID of the component to show [required]
    """
    result = component.list_files(context, id=id)
...
def delete_file(context, id, file_id):
    ...
    """
    return component.delete_file(context, id=id, file_id=file_id)
