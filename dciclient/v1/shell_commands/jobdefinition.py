...
def create(context, name, test_id, priority, topic_id):
    ...
    :param name: Name of the jobdefinition [required]
    :param test_id: ID of the test for this jobdefinition [required]
    :param topic_id: ID of the topic for this jobdefinition [required]
