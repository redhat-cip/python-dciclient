...
def parse_arguments(args, environment={}):
    ...
    # job commands
    p = subparsers.add_parser("job-list", help="List all jobs.")
    p.add_argument("--sort", default="-created_at")
    ...
    p = subparsers.add_parser("job-delete", help="Delete a job.")
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.set_defaults(command="job-delete")

    p = subparsers.add_parser("job-results", help="List all job results.")
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-attach-issue", help="Attach an issue to a job.")
    p.add_argument("id")
    p.add_argument("--url", required=True)
    p.set_defaults(command="job-attach-issue")

    p = subparsers.add_parser("job-unattach-issue", help="Unattach an issue to a job.")
    p.add_argument("id")
    p.add_argument("--issue-id", required=True)
    p.set_defaults(command="job-unattach-issue")

    p = subparsers.add_parser("job-list-issue", help="List all job attached issues.")
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-output", help="Show the job output.")
    p.add_argument("id")
    p.set_defaults(command="job-output")

    p = subparsers.add_parser("job-list-test", help="List all tests attached issues.")
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-delete-tag", help="Drop a tag to a job.")
    p.add_argument("id")
    p.add_argument("tag_id")
    p.set_defaults(command="job-delete-tag")

    p = subparsers.add_parser("job-list-tags", help="List all the tags of a job.")
    p.add_argument("id")
    p.set_defaults(command="job-list-tags")

    p = subparsers.add_parser("job-upload-file", help="Attach a file to a job.")
    p.add_argument("job_id")
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("job-download-file", help="Retrieve a job file.")
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.add_argument("--target", required=True)
    p.set_defaults(command="job-download-file")

    p = subparsers.add_parser("job-show-file", help="Show a job file.")
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.set_defaults(command="job-show-file")

    p = subparsers.add_parser("job-list-file", help="List files attached to a job.")
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
