...
def parse_arguments(args, environment={}):
    ...
    # user commands
    p = subparsers.add_parser("user-list", help="List all users.", parents=[base_parser])
    ...
    p = subparsers.add_parser("user-create", help="Create a user.", parents=[base_parser])
    ...
    p = subparsers.add_parser("user-update", help="Update a user.", parents=[base_parser])
    p.add_argument("id")
    ...
    p = subparsers.add_parser("user-delete", help="Update a user.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    ...
    # team commands
    p = subparsers.add_parser("team-list", help="List all teams.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("team-create", help="Create a team.", parents=[base_parser])
    p.add_argument("--name", required=True)
    p.add_argument("--country")
    _create_boolean_flags(p, "--active/--no-active", default=True, dest="state")
    p.set_defaults(command="team-create")

    p = subparsers.add_parser("team-update", help="Update a team.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument("--country")
    ...
    p = subparsers.add_parser("team-delete", help="Update a team.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    ...
    # analytic commands
    p = subparsers.add_parser("analytic-list", help="List all analytics.", parents=[base_parser])
    p.add_argument("--job-id")
    p.set_defaults(command="analytic-list")

    p = subparsers.add_parser("analytic-create", help="Create a analytic.", parents=[base_parser])
    ...
    p = subparsers.add_parser("analytic-update", help="Update a analytic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--job-id", required=True)
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("analytic-show", help="Show a analytic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--job-id", required=True)
    p.set_defaults(command="analytic-show")

    # product commands
    p = subparsers.add_parser("product-list", help="List all products.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("product-create", help="Create a product.", parents=[base_parser])
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("product-update", help="Update a product.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument("--label")
    ...
    p = subparsers.add_parser("product-delete", help="Update a product.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.set_defaults(command="product-delete")

    p = subparsers.add_parser("product-show", help="Show a product.", parents=[base_parser])
    p.add_argument("id")
    p.set_defaults(command="product-show")

    p = subparsers.add_parser("product-attach-team", help="Attach team to a product.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--team-id")
    p.set_defaults(command="product-attach-team")

    p = subparsers.add_parser("product-detach-team", help="Detach team to a product.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--team-id")
    ...
    # feeder commands
    p = subparsers.add_parser("feeder-list", help="List all feeders.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("feeder-create", help="Create a feeder.", parents=[base_parser])
    p.add_argument("--name", required=True)
    p.add_argument("--data")
    _create_boolean_flags(p, "--active/--no-active", default=True, dest="state")
    p.add_argument("--team-id")
    ...
    p = subparsers.add_parser("feeder-update", help="Update a feeder.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument("--data")
    ...
    p = subparsers.add_parser("feeder-delete", help="Update a feeder.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.set_defaults(command="feeder-delete")

    p = subparsers.add_parser("feeder-show", help="Show a feeder.", parents=[base_parser])
    p.add_argument("id")
    ...
    # topic commands
    p = subparsers.add_parser("topic-list", help="List all topics.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("topic-create", help="Create a topic.", parents=[base_parser])
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("topic-update", help="Update a topic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument(
    ...
    p = subparsers.add_parser("topic-delete", help="Delete a topic.", parents=[base_parser])
    p.add_argument("id")
    ...
    p = subparsers.add_parser("topic-attach-team", help="Attach a team to a topic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--team-id")
    p.set_defaults(command="topic-attach-team")

    p = subparsers.add_parser("topic-unattach-team", help="Unattach a team to a topic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--team-id")
    p.set_defaults(command="topic-unattach-team")

    p = subparsers.add_parser("topic-list-team", help="List teams attached to a topic.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    # jobstate commands
    p = subparsers.add_parser("jobstate-show", help="Show a jobstate.", parents=[base_parser])
    p.add_argument("id")
    p.set_defaults(command="jobstate-show")

    # component commands
    p = subparsers.add_parser("component-list", help="List all components.", parents=[base_parser])
    ...
    p = subparsers.add_parser("component-create", help="Create a component.", parents=[base_parser])
    ...
    p = subparsers.add_parser("component-update", help="Update a component.", parents=[base_parser])
    p.add_argument("id")
    _create_boolean_flags(p, "--active/--no-active", default=None, dest="state")
    p.set_defaults(command="component-update")

    p = subparsers.add_parser("component-delete", help="Delete a component.", parents=[base_parser])
    p.add_argument("id")
    p.set_defaults(command="component-delete")

    p = subparsers.add_parser("component-show", help="Show a component.", parents=[base_parser])
    p.add_argument("id")
    ...
    p = subparsers.add_parser("component-file-show", help="Show a component file.", parents=[base_parser])
    p.add_argument("id")
    ...
    p = subparsers.add_parser("component-file-delete", help="Delete a component file.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.set_defaults(command="component-file-delete")

    # file commands
    p = subparsers.add_parser("file-list", help="List all files.", parents=[base_parser])
    ...
    p = subparsers.add_parser("file-delete", help="Delete a file.", parents=[base_parser])
    p.add_argument("id")
    ...
    p = subparsers.add_parser("job-results", help="List all job results.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-attach-issue", help="Attach an issue to a job.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--url", required=True)
    p.set_defaults(command="job-attach-issue")

    p = subparsers.add_parser("job-unattach-issue", help="Unattach an issue to a job.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--issue-id", required=True)
    p.set_defaults(command="job-unattach-issue")

    p = subparsers.add_parser("job-list-issue", help="List all job attached issues.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-output", help="Show the job output.", parents=[base_parser])
    p.add_argument("id")
    p.set_defaults(command="job-output")

    p = subparsers.add_parser("job-list-test", help="List all tests attached issues.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-add-tag", help="Add a tag to a job.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("name")
    p.set_defaults(command="job-add-tag")

    p = subparsers.add_parser("job-delete-tag", help="Drop a tag to a job.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("tag_id")
    p.set_defaults(command="job-delete-tag")

    p = subparsers.add_parser("job-list-tags", help="List all the tags of a job.", parents=[base_parser])
    p.add_argument("id")
    p.set_defaults(command="job-list-tags")

    p = subparsers.add_parser("job-upload-file", help="Attach a file to a job.", parents=[base_parser])
    p.add_argument("job_id")
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("job-download-file", help="Retrieve a job file.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.add_argument("--target", required=True)
    p.set_defaults(command="job-download-file")

    p = subparsers.add_parser("job-show-file", help="Show a job file.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.set_defaults(command="job-show-file")

    p = subparsers.add_parser("job-list-file", help="List files attached to a job.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    ...
    p = subparsers.add_parser("job-delete-file", help="Delete a job file.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--file-id", required=True)
    p.set_defaults(command="job-delete-file")

    # test commands
    p = subparsers.add_parser("test-list", help="List all tests.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("test-create", help="Create a test.", parents=[base_parser])
    p.add_argument("--name")
    p.add_argument("--data", default="{}")
    _create_boolean_flags(p, "--active/--no-active", default=True, dest="state")
    p.set_defaults(command="test-create")

    p = subparsers.add_parser("test-update", help="Update a test.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument("--data", default="{}")
    ...
    p = subparsers.add_parser("test-delete", help="Delete a test.", parents=[base_parser])
    p.add_argument("id")
    ...
    # remoteci commands
    p = subparsers.add_parser("remoteci-list", help="List all remotecis.", parents=[base_parser])
    p.add_argument("--sort", default="-created_at")
    p.add_argument("--limit", default=50)
    p.add_argument("--offset", default=0)
    p.add_argument("--where", help="Optional filter criteria", required=False)
    ...
    p = subparsers.add_parser("remoteci-create", help="Create a remoteci.", parents=[base_parser])
    p.add_argument("--name", required=True)
    ...
    p = subparsers.add_parser("remoteci-update", help="Update a remoteci.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.add_argument("--name")
    p.add_argument("--team-id")
    ...
    p = subparsers.add_parser("remoteci-delete", help="Delete a remoteci.", parents=[base_parser])
    p.add_argument("id")
    p.add_argument("--etag", required=True)
    p.set_defaults(command="remoteci-delete")

    p = subparsers.add_parser("remoteci-show", help="Show a remoteci.", parents=[base_parser])
    p.add_argument("id")
    ...
    # purge commands
    p = subparsers.add_parser("purge", help="Purge soft-deleted resources.", parents=[base_parser])
    p.add_argument(
