...
def ensure_componenttype(session, componenttypes):
    ...
    #    try:
        #componenttype_ids.append(l_componenttype.create(name=ct_name)['id'])
        componenttype_ids.append(l_componenttype.create(name=ct_name).json()['componenttype']['id'])
    #    except AlreadyExist:
    #        componenttype_ids.append(l_componenttype.show(name=ct_name)['id'])
    #        pass
    #    except Exception e:
    #        raise e
...
def ensure_test(session, tests):
    ...
    for t_name in tests:
        ...
        #except AlreadyExist:
        #    test_ids.append(l_test.show(name=t_name)['id'])
        #    pass
        #except Exception e:
        #    raise e
