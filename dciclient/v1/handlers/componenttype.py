...
class ComponentType(DCIBaseComponent):
    ...
    def __init__(self, dci_client):
        DCIBaseComponent.__init__(self, dci_client)
        self._end_point_with_uri = '%s/%s' % (self._dci_client._end_point, self.ENDPOINT_URI)
    ...
    def update(self, _id=None, etag=None, name=None):
        ...
        #    raise ClientError("parameters missing: _id='%s', "
        #                      "etag='%s', name='%s'" %
        #                      (_id, etag, name))
