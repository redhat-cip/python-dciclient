...
def test_list(runner):
    ...
    runner.invoke(['component-create', 'foo', topic['id'], 'bar'])
    runner.invoke(['component-create', 'bar', topic['id'], 'bar2'])
    components = runner.invoke([
        'component-list', topic['id']])['components']
...
def test_create(runner):
    ...
    component = runner.invoke(['component-create', 'foo',
...
def test_show(runner):
    ...
    component = runner.invoke([
        'component-create', 'foo', topic['id'], 'bar',
...
def test_file_support(runner, tmpdir):
    ...
    # delete
    runner.invoke_raw(['component-file-delete', component['id'], new_f['id']])
