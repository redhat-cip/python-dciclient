...
def test_get_job_with_signature_context_succeeds(server, job_id, remoteci_id):
    pass
    # ctx = build_signature_context(dci_cs_url='', dci_client_id=remoteci_id)
    # r = job.get(ctx,job_id)
