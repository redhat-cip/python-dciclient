...
for arch in fedora-23-x86_64 epel-7-x86_64; do
    ...
    sed -i '$ibaseurl=https://packages.distributed-ci.io/repos/development/el/7/x86_64/' ${HOME}/.mock/${arch}-with-dci-repo.cfg
    ...
    sed -i '$ibaseurl=https://packages.distributed-ci.io/repos/extras/el/7/x86_64/' ${HOME}/.mock/${arch}-with-dci-repo.cfg
    sed -i '$igpgcheck=0' ${HOME}/.mock/${arch}-with-dci-repo.cfg
    sed -i '$ienabled=1' ${HOME}/.mock/${arch}-with-dci-repo.cfg
