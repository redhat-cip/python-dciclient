...
class CallbackModule(callback.CallbackBase):
    def __init__(self):
        ...
        #     'admin',
        #     'admin')
        self._remoteci_id = 'ac7a3fd4-a663-48c8-ada3-c29f0ad3c7f5'
        self._topic_id = '76180ffa-9677-4d00-b468-99242145d87b'
    ...
    def v2_playbook_on_start(self, playbook):
        ...
        # scheduled_job = job.schedule(self._dci_context,
        #                              self._remoteci_id,
        #                              self._topic_id)
        # self._job_id = scheduled_job.json()['job']['id']
        print("*** Job id: %s\n" % self._job_id)

    def v2_playbook_on_stats(self, stats):
        """Event executed after running the playbook. Get the stats of the
        playbook and create the final jobstate."""
