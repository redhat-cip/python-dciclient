...
if __name__ == '__main__':
    ...
    runner = Runner(playbook='site2.yml',
                    dci_context=None,#_dci_context,
                    verbosity=3)
    # get user from ansible/hosts file
    local_logs_path = '%s/logs' % datas_dir
    remote_logs_path = '/home/centos/agent_datas/logs'
    runner.run('my-kikoolol-jobid', local_logs_path, remote_logs_path)
