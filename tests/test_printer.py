...
from dciclient.printer import get_headers_and_sizes_from_data
from dciclient.printer import format_line
from dciclient.printer import adjust_column_width_to_console
from dciclient.printer import adjust_text
from dciclient.printer import split_strings
from dciclient.printer import create_line_content
from dciclient.printer import format_data_line
from dciclient.printer import format_text
from dciclient.printer import format_headers_line
from dciclient.v1.utils import format_lines_adjusted_to_console
from dciclient.v1.utils import find_longest_header
...
def test_find_longest_header():
    headers_and_sizes = [
        {"size": 5, "name": "id"},
        {"size": 15, "name": "name"},
        {"size": 5, "name": "email"},
    ]
    assert find_longest_header(headers_and_sizes) == 15
    ...
    assert find_longest_header(headers_and_sizes) == 5
...
def test_adjust_column_width_to_console():
    ...
    # IF COLUMN IS TOO SMALL TO FIT TEXT
    data = [
        {"size": 36, "name": "id"},
        {"size": 4, "name": "name"},
        {"size": 18, "name": "email"},
    ...
    assert adjust_column_width_to_console(data, console_width=20) == expected_headers
    ...
    assert adjust_column_width_to_console(data, console_width=11) == '[]'
