...
from dciclient.v1.utils import get_longest_header
...
def test_get_longest_header():
    headers_and_sizes = [
        {"size": 5, "name": "id"},
        {"size": 15, "name": "name"},
        {"size": 5, "name": "email"},
    ]
    assert get_longest_header(headers_and_sizes) == 15
    ...
    assert get_longest_header(headers_and_sizes) == 5
