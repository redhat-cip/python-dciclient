...
"""
with open('dci_agent.yaml', 'r') as fd:
...
ctx = dci_context.build_dci_context(**dci_conf['auth']) 
...
with open('/var/www/html/RHOS-DCI.repo', 'w') as f:
    for component in job_full_data['components']:
        subprocess.check_call([
            'rsync',
            '-av',
            '--hard-links',
            'rsync@46.231.133.207:/var/www/html' + component['data']['path'] + '/',
